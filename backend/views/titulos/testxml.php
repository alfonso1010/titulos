...
<div class="site-index">
    <div class="body-content">
        ...
        <div class="row" style="margin-left:15px ">
            <div class="col-xs-8">
            	<h3 style="color: brown">Test Firma Título Electrónico XML</h3>
            </div>
        </div>
        ...
        <center><?=Html::submitButton("Revisar", ['class' => 'btn btn-success','style' => "font-size:20px"])?></center>
        <?php ActiveForm::end();?>
    </div>
</div>
<style type="text/css">
