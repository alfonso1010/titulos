...
<div class="site-index">
    ...
    <div class="body-content">
    	<div class="row" style="margin-left:15px ">
        	<div class="col-xs-12">
          		<h3 style="color: brown">Títulos enviados a QA</h3>
          <?= Button::widget([
...
<div class="modal fade" id="ModalWSdes" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <?php
    $form = ActiveForm::begin([
      'id'       => 'active-form',
      'action'   => Url::to(['titulos/descargarqa']),
      'options'  => [
...
<?php
  $url_consultar =Url::to(['titulos/consultarqa']);
  $url_cancelar =Url::to(['titulos/cancelarqa']);
?>
